...
namespace Core.Migrations
{
    ...
    [Migration("20220409132052_UserRefreshTokenGuid")]
    partial class UserRefreshTokenGuid
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Models.User.UserProfile", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Core.Models.Authentication.UserRefreshToken", b =>
                {
                    b.HasOne("Core.Models.User.UserProfile", null)
                        .WithOne()
                        .HasForeignKey("Core.Models.Authentication.UserRefreshToken", "UserId")
            ...
            modelBuilder.Entity("Core.Models.User.UserProfile", b =>
                {
                    b.OwnsOne("Core.Models.User.TimeSessionOptions", "TimeSessionOptions", b1 =>
                        {
                            b1.Property<long>("UserProfileId")
                                .HasColumnType("bigint");

                            b1.Property<int>("BreakSessionDuration")
                                .HasColumnType("integer");

                            b1.Property<int>("DailyWorkDuration")
                                .HasColumnType("integer");

                            b1.Property<int>("WorkSessionDuration")
                                .HasColumnType("integer");
                    ...
                    b.Navigation("TimeSessionOptions");
                });
